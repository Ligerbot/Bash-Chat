...
Add tabs for choosing between servers?

Make GPG key be stored in the ~/.local/chatapp instead of the system keystore?

Ensure that encryption still works right between n number of recipients.
